...
\begin{exercise} 证明式\tbobject{eq:ch37-patchify}可逆，并说明当滑窗重叠、忽略边界或带填充时，哪些结论发生变化。
...
\begin{exercise} 当 $d=512,\rho=4$ 时，求式\tbobject{eq:ch37-cost}中线性项与二次项相等的序列长度；解释这为何不是硬件延迟交点。

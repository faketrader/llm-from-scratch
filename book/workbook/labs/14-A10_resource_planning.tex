...
\noindent\textbf{教材关联：}\bookxrefshort{ch:rev-moe}、\bookxrefshort{ch:long-context}、\bookxrefshort{ch:open-models}、\bookxrefshort{ch:resource-budget}、\bookxrefshort{ch:pretraining-scaling}、\bookxrefshort{ch:compute-infrastructure}。

...
\noindent\textbf{教材关联：}\bookxrefshort{ch:tokenization}、\bookxrefshort{ch:attention}、\bookxrefshort{ch:position-representation}、\bookxrefshort{ch:transformer}、\bookxrefshort{ch:autoregressive}、\bookxrefshort{ch:long-context}。

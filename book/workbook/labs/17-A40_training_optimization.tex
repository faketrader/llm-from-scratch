...
\noindent\textbf{教材关联：}\bookxrefshort{ch:moe}、\bookxrefshort{ch:training-stability}、\bookxrefshort{ch:parameter-efficient-finetuning}、\bookxrefshort{ch:efficient-finetuning}、\bookxrefshort{ch:compute-infrastructure}、\bookxrefshort{ch:distributed-training}。

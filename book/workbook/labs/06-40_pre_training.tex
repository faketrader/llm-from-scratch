...
\noindent\textbf{教材关联：}\bookxrefshort{ch:rev-probability}、\bookxrefshort{ch:optimization-generalization}、\bookxrefshort{ch:pretraining-scaling}、\bookxrefshort{ch:training-stability}、\bookxrefshort{ch:distributed-training}。

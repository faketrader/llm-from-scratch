...
\begin{lfsalgorithmic}[1]
 ...
 \State 由式\eqref{eq:vit-index}确定补丁次序，使用式\eqref{eq:vit-embedding}或等价卷积投影。保持权重排列与像素排列一致。
 ...
 \State 对 $t=1,\ldots,T$ 执行式\eqref{eq:vit-block}，保持序列长度和隐藏维度不变；推理时停用训练期随机失活。

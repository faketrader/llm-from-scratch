...
\begin{document}
\begin{tikzpicture}[lfs picture, >=Latex, node distance=8mm]

\tikzset{
  biasbox/.style={draw=LFSRed, fill=LFSRedSoft, rounded corners=3pt, font=\small\bfseries, align=center, inner sep=5pt, minimum width=46mm, minimum height=14mm},
  fixbox/.style={draw=LFSGreen, fill=LFSGreenSoft, rounded corners=3pt, font=\small, align=center, inner sep=5pt, minimum width=46mm, minimum height=14mm},
  title/.style={font=\normalsize\bfseries, text=LFSGray, align=center}
}
...
\draw[->, draw=LFSOrange, line width=1pt] (b1) -- (f1);
...
\draw[->, draw=LFSOrange, line width=1pt] (b2) -- (f2);
...
\draw[->, draw=LFSOrange, line width=1pt] (b3) -- (f3);
...
\draw[->, draw=LFSOrange, line width=1pt] (b4) -- (f4);

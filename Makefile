...
$(FIGURE_SOURCE_DIR)/%.pdf: $(FIGURE_SOURCE_DIR)/%.tex $(FIGURE_SOURCE_DIR)/diagram_styles.tex book/my-math.sty Makefile
	@mkdir -p "build/figures/$*"
	latexmk -g -xelatex -usepretex='\PassOptionsToPackage{fontset=founder}{ctex}' -outdir="$(abspath build/figures/$*)" "$<"
